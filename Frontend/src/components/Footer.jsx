...
import Skyline from '../assets/Skyline.svg';  // Ensure the path is correct
import GooglePlay from '../assets/GooglePlay.svg';  // Ensure the path is correct
import AppStore from '../assets/AppStore.svg';  // Ensure the path is correct

function Footer() {
  return (
    <footer className="bg-[#236C13] text-white">
      {/* Skyline Graphic */}
      <div className="h-[100px] flex justify-center items-center">
        <img src={Skyline} alt="Skyline" className="w-full h-full object-cover" />
      </div>
