  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'create-account':
        return (
          <div className='bg-white p-4 rounded-lg'>
            <img src={create} alt="Create Account" className="mb-4 block mx-auto max-w-full h-auto pt-20 px-20" />
      ...
      case 'browse-products':
        return (
          <div className='bg-white p-20 rounded-lg'>
            <img src={browseProductImage} alt="Create Account" className="mb-4 block mx-auto max-w-full h-auto pt-10 px-20" />
            <div className='px-40 pb-40'>
      ...
      case 'connect-vendors':
        return (
          <div className='bg-white p-20 rounded-lg'>
            <img src={connectVendorsImage} alt="Create Account" className="mb-4 block mx-auto max-w-full h-auto pt-10 px-20" />
            <div className='px-40 pb-40'>
      ...
      case 'place-ads':
        return (
          <div className='bg-white p-20 rounded-lg'>
            <img src={placeAds} alt="Create Account" className="mb-4 block mx-auto max-w-full h-auto pt-10 px-20" />
            <div className='px-40 pb-40'>
      ...
      case 'payments':
        return (
          <div className='bg-white p-20 rounded-lg'>
            <img src={paymentsImage} alt="Create Account" className="mb-4 block mx-auto max-w-full h-auto pt-10 px-20" />
            <div className='px-40 pb-40'>
      ...
      case 'safety-security':
        return (
          <div className='bg-white p-20 rounded-lg'>
            <img src={safetySecurityImage} alt="Create Account" className="mb-4 block mx-auto max-w-full h-auto pt-10 px-20" />
            <div className='px-40 pb-40'>
    ...
    <div className="flex flex-col bg-gray-100 min-h-screen">
      ...
      <div className="flex flex-1">
        ...
        <div className="w-1/4 bg-white p-6">
          <ul>
            <li
              className={`cursor-pointer p-3 mb-2 ${activeTab === 'create-account' ? 'bg-green text-white rounded-lg focus:font-semibold' : 'bg-white text-gray-900 hover:bg-green hover:text-white hover:opacity-75 rounded-lg focus:font-semibold'}`}
              onClick={() => setActiveTab('create-account')}
            >
              Create an Account
            </li>
            <li
              className={`cursor-pointer p-3 mb-2 ${activeTab === 'browse-products' ? 'bg-green text-white rounded-lg focus:font-semibold' : 'bg-white text-gray-900 hover:bg-green hover:text-white hover:opacity-75 rounded-lg focus:font-semibold'}`}
              onClick={() => setActiveTab('browse-products')}
            >
              Browse and Search for Products
            </li>
            <li
              className={`cursor-pointer p-3 mb-2 ${activeTab === 'connect-vendors' ? 'bg-green text-white rounded-lg focus:font-semibold'  : 'bg-white text-gray-900 hover:bg-green hover:text-white hover:opacity-75 rounded-lg focus:font-semibold'}`}
              onClick={() => setActiveTab('connect-vendors')}
            >
              Connect with Vendors
            </li>
            <li
              className={`cursor-pointer p-3 mb-2 ${activeTab === 'place-ads' ? 'bg-green text-white rounded-lg focus:font-semibold' : 'bg-white text-gray-900 hover:bg-green hover:text-white hover:opacity-75 rounded-lg focus:font-semibold'}`}
              onClick={() => setActiveTab('place-ads')}
            >
              Place Ads
            </li>
            <li
              className={`cursor-pointer p-3 mb-2 ${activeTab === 'payments' ? 'bg-green text-white rounded-lg focus:font-semibold' : 'bg-white text-gray-900 hover:bg-green hover:text-white hover:opacity-75 rounded-lg focus:font-semibold'}`}
              onClick={() => setActiveTab('payments')}
            >
              Payments
            </li>
            <li
              className={`cursor-pointer p-3 mb-2  ${activeTab === 'safety-security' ? 'bg-green text-white rounded-lg focus:font-semibold ' : 'bg-white text-gray-900 hover:bg-green hover:text-white hover:opacity-75 rounded-lg focus:font-semibold'}`}
