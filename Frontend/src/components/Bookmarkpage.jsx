...
const BookmarksPage = () => {
  ...
  return (
    <div className="mx-auto p-4 w-full max-w-md h-[100vh] container">
      <div className="flex items-center mb-4">
        <Link to="/" className="text-Primary hover:text-orange">
          <FontAwesomeIcon icon={faArrowLeft} className="w-6 h-6" />
        </Link>
        <h1 className="ml-4 font-bold text-2xl text-Primary">Bookmarks</h1>
      </div>
      {bookmarks.length === 0 ? (
        <p className="text-center text-Primary">No bookmarks yet.</p>
      ) : (
