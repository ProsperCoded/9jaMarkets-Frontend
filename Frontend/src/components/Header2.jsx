    ...
    <div>
      ...
      <header className="bg-green text-white top-0 w-full z-10">
        <div className="container mx-auto flex justify-between items-center p-2 text-3xl font-bold h-14">
          ...
          <div className="flex space-x-4 items-center"> {/* Add items-center to center icons vertically */}
            <Link to="/chat" className="hover:text-orange"> {/* Added flex and justify-center */}
