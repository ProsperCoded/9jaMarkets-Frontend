        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="md:hidden flex items-center gap-4">
              <Link to="/markets" className="text-gray-600 text-lg">
                Markets
              </Link>
              <Link to="/malls" className="font-bold text-Primary text-lg">
                Malls
              </Link>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 md:gap-6">
              {filteredMalls.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="p-3 md:p-4">
                      ...
                      <div className="flex items-start gap-2 mt-2 text-gray-600">
                        ...
                        <p className="text-xs md:text-sm line-clamp-2">{mall.address}</p>
                      </div>
                    </div>
                  </Link>
                ))
                ...
                <div className="col-span-full text-center py-8">
                  <p className="text-gray-600">No malls found for "{searchTerm}"</p>
                </div>
              )}
            </div>
          </div>
