const MARKETS = {
  ...
  Bauchi: [
    ...
    { name: "Jama'are Market", img: "./markets/bauchi/jamaare.jpg", address: "Jama'are Town, Jama'are LGA" },
    { name: "Katagum Market", img: "./markets/bauchi/katagum.jpg", address: "Katagum Town, Zaki LGA" },
    { name: "Misau Market", img: "./markets/bauchi/misau.jpg", address: "Misau Town, Misau LGA" },
    { name: "Muda Lawal Market", img: "./markets/bauchi/muda-lawal.jpg", address: "Muda Lawal Area, Bauchi City" },
    { name: "Ningi Market", img: "./markets/bauchi/ningi.jpg", address: "Ningi Town, Ningi LGA" },
    { name: "Tafawa Balewa Market", img: "./markets/bauchi/tafawa-balewa.jpg", address: "Tafawa Balewa Town, Tafawa Balewa LGA" },
    { name: "Warji Market", img: "./markets/bauchi/warji.jpg", address: "Warji Town, Warji LGA" },
    { name: "Wunti Market", img: "./markets/bauchi/wunti.jpg", address: "Wunti Area, Bauchi City" },
  ],
  ...
  Benue: [
    { name: "Achia Market", img: "./markets/benue/achia.jpg", address: "Kwande LGA, Benue State" },
    { name: "Ada Market", img: "./markets/benue/ada.jpg", address: "Kwande LGA, Benue State" },
    { name: "Adikpo Market", img: "./markets/benue/adikpo.jpg", address: "Adikpo, Kwande LGA, Benue State" },
    { name: "Adu Market", img: "./markets/benue/adu.jpg", address: "Kwande LGA, Benue State" },
    { name: "Akpehe Market", img: "./markets/benue/akpehe.jpg", address: "Makurdi, Benue State" },
    { name: "Gboko Main Market", img: "./markets/benue/gboko-main.jpg", address: "Gboko, Benue State" },
    { name: "High-Level Market", img: "./markets/benue/high-level.jpg", address: "Makurdi, Benue State" },
    { name: "Iyon Market", img: "./markets/benue/iyon.jpg", address: "Kwande LGA, Benue State" },
    { name: "Kookoko Market", img: "./markets/benue/kookoko.jpg", address: "Kwande LGA, Benue State" },
    { name: "Makurdi Modern Market", img: "./markets/benue/makurdi-modern.jpg", address: "Makurdi, Benue State" },
    { name: "North Bank Market", img: "./markets/benue/north-bank.jpg", address: "Makurdi, Benue State" },
    { name: "Otukpo Main Market", img: "./markets/benue/otukpo-main.jpg", address: "Otukpo, Benue State" },
    { name: "Railway Market", img: "./markets/benue/railway.jpg", address: "Makurdi, Benue State" },
    { name: "Wadata Market", img: "./markets/benue/wadata.jpg", address: "Makurdi, Benue State" },
  ...
  Gombe: [
    ...
    { name: "Deba Market", img: "./markets/gombe/deba.jpg", address: "Deba Town, Yamaltu/Deba LGA" },
    ...
    { name: "Mallam Sidi Market", img: "./markets/gombe/mallam-sidi.jpg", address: "Mallam Sidi Town, Kwami LGA" },
    ...
    { name: "Tumu Market", img: "./markets/gombe/tumu.jpg", address: "Tumu Town, Akko LGA" },
    { name: "Wade Market", img: "./markets/gombe/wade.jpg", address: "Wade Town, Yamaltu/Deba LGA" },
  ],
  ...
  Niger: [
    ...
    { name: "Bida Main Market", img: "./markets/niger/bida.jpg", address: "Bida, Niger State" },
    ...
    { name: "Minna Central Market", img: "./markets/niger/minna.jpg", address: "Minna, Niger State" },
    ...
    { name: "Suleja Market", img: "./markets/niger/suleja.jpg", address: "Suleja, Niger State" },
  ...
  Taraba: [
    ...
    { name: "Central Market", img: "./markets/taraba/central.jpg", address: "Emirs Palace Area, Jalingo, Taraba State" },
    ...
    { name: "Wukari Main Market", img: "./markets/taraba/wukari.jpg", address: "Wukari Town, Wukari LGA, Taraba State" },
  ],
