const MARKETS = {
  ...
  FCT: [
    { name: "Apo Mechanic Village Market", img: "./markets/abuja/apo-mechanic.jpg", address: "Apo, Abuja" },
    { name: "Dei-Dei Building Materials Market", img: "./markets/abuja/dei-dei.jpeg", address: "Dei-Dei, Abuja" },
    { name: "Dutse Market", img: "./markets/abuja/dutse.jpg", address: "Dutse Alhaji, Abuja" },
    { name: "Garki International Market", img: "./markets/abuja/garki.jpeg", address: "Garki, Abuja" },
    ...
    { name: "Jabi Motor Park Market", img: "./markets/abuja/jabi-motor.jpg", address: "Jabi, Abuja" },
    ...
    { name: "Lugbe Market", img: "./markets/abuja/lugbe.jpeg", address: "Lugbe, Abuja" },
    { name: "Nyanya Market", img: "./markets/abuja/nyanya.jpeg", address: "Nyanya, Abuja" },
