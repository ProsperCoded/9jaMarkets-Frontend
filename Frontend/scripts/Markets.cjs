const MARKETS = {
  ...
  Plateau: [
    ...
    { name: "Langtang Market", img: "./markets/plateau/langtang.jpg", address: "Langtang, Plateau State" },
    ...
    { name: "Qua'an Pan Market", img: "./markets/plateau/quaan-pan.jpg", address: "Qua'an Pan, Plateau State" },
    { name: "Riyom Market", img: "./markets/plateau/riyom.jpg", address: "Riyom, Plateau State" },
  ...
  Rivers: [
    ...
    { name: "Creek Road Market (Zoo Town Market)", img: "./markets/rivers/creek-road.jpg", address: "Creek Road, Port Harcourt, Rivers State" },
    ...
    { name: "Mile One Market", img: "./markets/rivers/mile-one.jpg", address: "Diobu, Port Harcourt, Rivers State" },
