const MARKETS = {
  ...
  Bayelsa: [
    { name: "Akassa Fish Market", img: "./markets/bayelsa/akassa.jpg", address: "Akassa" },
    { name: "Aleibiri Market", img: "./markets/bayelsa/aleibiri.jpg", address: "Aleibiri" },
    { name: "Amabulou Market", img: "./markets/bayelsa/amabulou.jpg", address: "Amabulou" },
    { name: "Amassoma Market", img: "./markets/bayelsa/amassoma.jpg", address: "Amassoma" },
    { name: "Anyama-Ogbia Market", img: "./markets/bayelsa/anyama-ogbia.jpg", address: "Anyama-Ogbia" },
    { name: "Brass Market", img: "./markets/bayelsa/brass.jpg", address: "Brass" },
    { name: "Darazo Market", img: "./markets/bayelsa/darazo.jpg", address: "Darazo" },
    { name: "Egwema Local Market", img: "./markets/bayelsa/egwema.jpg", address: "Egwema" },
    { name: "Ekeki Market", img: "./markets/bayelsa/ekeki.jpg", address: "Ekeki" },
    { name: "Ekeremor Main Market", img: "./markets/bayelsa/ekeremor.jpg", address: "Ekeremor" },
    { name: "Kolo Market", img: "./markets/bayelsa/kolo.jpg", address: "Kolo" },
    { name: "Ofoni Market", img: "./markets/bayelsa/ofoni.jpg", address: "Ofoni" },
    { name: "Opolo Market", img: "./markets/bayelsa/opolo.jpg", address: "Opolo" },
    { name: "Oporoma Market", img: "./markets/bayelsa/oporoma.jpg", address: "Oporoma" },
    { name: "Opu-Nembe Market", img: "./markets/bayelsa/opu-nembe.jpg", address: "Opu-Nembe" },
    { name: "Peretoru Local Market", img: "./markets/bayelsa/peretoru.jpg", address: "Peretoru" },
    { name: "Sagbama Market", img: "./markets/bayelsa/sagbama.jpg", address: "Sagbama" },
    { name: "Tombia Market", img: "./markets/bayelsa/tombia.jpg", address: "Tombia" },
    { name: "Toru-Orua Market", img: "./markets/bayelsa/toru-orua.jpg", address: "Toru-Orua" },
    { name: "Twon Brass Market", img: "./markets/bayelsa/twon-brass.jpg", address: "Twon Brass" },
    { name: "Yelwa Market", img: "./markets/bayelsa/yelwa.jpg", address: "Yelwa" },
  ],
